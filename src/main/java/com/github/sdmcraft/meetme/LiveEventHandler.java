...
public class LiveEventHandler implements AsteriskServerListener,
    ...
    public void onNewMeetMeUser(MeetMeUser user) {
        ...
        try {
            ...
            if(conference == null) {
                logger.warning("User " + user.getUserNumber() + " joined a non-existent conference " + user.getRoom().getRoomNumber());
            } else {
    ...
    public void propertyChange(PropertyChangeEvent propertyChangeEvent) {
        ...
        if (propertyChangeEvent.getPropertyName().equals("state") &&
                propertyChangeEvent.getOldValue().toString().equals("RINGING") &&
    ...
    public void onManagerEvent(ManagerEvent managerEvent) {
        ...
        if (managerEvent instanceof MeetMeEndEvent) {
            ...
            if (ChannelState.UP.ordinal() == stateEvent.getChannelState()) {
                for (Conference conference : context.getConferences().values()) {
                    List<String> answeredDialouts = new ArrayList<String>();
                    ...
                    conference.getPendingDialOuts().removeAll(answeredDialouts);
                }
            }
        }
    }
